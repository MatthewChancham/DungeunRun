...
class Player:
    ...
    def populate_skills(self):
        ...
        if self.class_name=='Mage':
            ...
            self.skills.append({'skill': blink,'name':'Blink','key':0,'level':10,'cooldown':3,'last_used':0,'cooldown_mod':1.0})
            ...
            self.skills.append({'skill': summon_sentry,'name':'Summon Range Sentry','key':0,'level':15,'cooldown':2,'last_used':0,'cooldown_mod':1.0})
