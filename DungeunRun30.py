...
SKILL_TREES = {
    'Warrior': [
        ...
        {'name': 'Iron Constitution',       'tier': 2, 'prereq': ['Strikes'],               'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +15 Max HP, +2 Vitality.',                             'branch': 'right',  'passive': {'max_hp_bonus': 15, 'vitality': 2}},
        {'name': 'Battle Hardened',         'tier': 3, 'prereq': ['Iron Constitution'],     'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +5 Strength.',                                         'branch': 'right',  'passive': {'strength': 5}},
        {'name': "Warlord's Might",         'tier': 4, 'prereq': ['Battle Hardened'],       'cost': 2, 'type': 'passive', 'desc': 'PASSIVE: +8 Strength, +10 Max HP.',                               'branch': 'right',  'passive': {'strength': 8, 'max_hp_bonus': 10}},
    ],
    'Mage': [
        ...
        {'name': 'Arcane Mind',             'tier': 2, 'prereq': ['Mana Bolt'],             'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +15 Max Mana, +2 Intelligence.',                       'branch': 'right',  'passive': {'max_mana_bonus': 15, 'intelligence': 2}},
        ...
        {'name': 'Mana Surge',              'tier': 4, 'prereq': ['Mana Bubble'],           'cost': 2, 'type': 'passive', 'desc': 'PASSIVE: +4 Intelligence, +4 Wisdom, +2 Mana Regen.',           'branch': 'right',  'passive': {'intelligence': 4, 'wisdom': 4}},
    ],
    'Rogue': [
        ...
        {'name': 'Fleet Foot',              'tier': 2, 'prereq': ['Dark Slash'],            'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +2 Agility, +10% Move Speed.',                         'branch': 'right',  'passive': {'agility': 2}},
        {'name': 'Poison Edge',             'tier': 3, 'prereq': ['Fleet Foot'],            'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +3 Agility, +3 Strength.',                              'branch': 'right',  'passive': {'agility': 3, 'strength': 3}},
        {'name': 'Shadow Mastery',          'tier': 4, 'prereq': ['Poison Edge'],           'cost': 2, 'type': 'passive', 'desc': 'PASSIVE: +5 Agility, +8 Strength.',                               'branch': 'right',  'passive': {'agility': 5, 'strength': 8}},
    ],
    'Cleric': [
        ...
        {'name': 'Holy Fortitude',          'tier': 2, 'prereq': ['Light Bolt'],            'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +15 Max HP, +2 Vitality.',                             'branch': 'right',  'passive': {'max_hp_bonus': 15, 'vitality': 2}},
        {'name': 'Blessed Aura',            'tier': 3, 'prereq': ['Holy Fortitude'],        'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +2 Will, +2 Wisdom, improved HP Regen.',               'branch': 'right',  'passive': {'will': 2, 'wisdom': 2}},
        {'name': 'Divine Grace',            'tier': 4, 'prereq': ['Blessed Aura'],          'cost': 2, 'type': 'passive', 'desc': 'PASSIVE: +4 Will, +4 Wisdom, +15 Max Mana.',                    'branch': 'right',  'passive': {'will': 4, 'wisdom': 4, 'max_mana_bonus': 15}},
    ],
    'Druid': [
        ...
        {"name": "Nature's Resilience",     'tier': 2, 'prereq': ['Thorn Whip'],            'cost': 1, 'type': 'passive', 'desc': "PASSIVE: +15 Max HP, +2 Wisdom.",                               'branch': 'right',  'passive': {'max_hp_bonus': 15, 'wisdom': 2}},
        {'name': 'Wild Growth',             'tier': 3, "prereq": ["Nature's Resilience"],   'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +3 Wisdom, +2 Vitality, improved HP Regen.',           'branch': 'right',  'passive': {'wisdom': 3, 'vitality': 2}},
        {'name': 'Ancient Bond',            'tier': 4, 'prereq': ['Wild Growth'],           'cost': 2, 'type': 'passive', 'desc': 'PASSIVE: +5 Wisdom, +5 Intelligence, +15 Max Mana.',            'branch': 'right',  'passive': {'wisdom': 5, 'intelligence': 5, 'max_mana_bonus': 15}},
    ],
    'Monk': [
        ...
        {'name': 'Iron Body',               'tier': 2, 'prereq': ['Chi Strike'],            'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +20 Max HP, +3 Vitality.',                             'branch': 'right',  'passive': {'max_hp_bonus': 20, 'vitality': 3}},
        {'name': 'Inner Peace',             'tier': 3, 'prereq': ['Iron Body'],             'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +2 Vitality, +4 Constitution, improved HP Regen.',     'branch': 'right',  'passive': {'vitality': 2, 'constitution': 4}},
        {'name': 'Transcendence',           'tier': 4, 'prereq': ['Inner Peace'],           'cost': 2, 'type': 'passive', 'desc': 'PASSIVE: +5 Vitality, +5 Constitution, +30 Max HP.',            'branch': 'right',  'passive': {'vitality': 5, 'constitution': 5, 'max_hp_bonus': 30}},
    ],
    'Ranger': [
        ...
        {'name': 'Eagle Eye',               'tier': 2, 'prereq': ['Arrow Shot'],            'cost': 1, 'type': 'passive', 'desc': 'PASSIVE: +2 Agility, +3 Strength.',                              'branch': 'right',  'passive': {'agility': 2, 'strength': 3}},
        {"name": "Hunter's Mark",           'tier': 3, 'prereq': ['Eagle Eye'],             'cost': 1, 'type': 'passive', 'desc': "PASSIVE: +3 Agility, +3 Strength.",                             'branch': 'right',  'passive': {'agility': 3, 'strength': 3}},
        {'name': 'Lethal Precision',        'tier': 4, "prereq": ["Hunter's Mark"],         'cost': 2, 'type': 'passive', 'desc': 'PASSIVE: +5 Agility, +8 Strength.',                               'branch': 'right',  'passive': {'agility': 5, 'strength': 8}},
    ],
}
...
class Player:
    ...
    def update_stats(self):
        ...
        # Apply passive bonuses from the skill tree
        tree = SKILL_TREES.get(self.class_name, [])
        for node in tree:
            if node['type'] == 'passive' and node['passive'] and node['name'] in getattr(self, 'tree_unlocked', set()):
                for stat, val in node['passive'].items():
                    if stat == 'max_hp_bonus':
                        self.max_hp += val
                    elif stat == 'max_mana_bonus':
                        self.max_mana += val
                    elif stat in ('strength','vitality','agility','intelligence','wisdom','will','constitution'):
...
class GameFrame(tk.Frame):
    ...
    def open_combined_skill_page(self):
        """Open a single tabbed window: Skill Tree + Skill Management."""
        ...
        # Use the proper embed method — creates canvas + all widgets inside tree_tab
        stw = SkillTreeWindow.embed_in_frame(tree_tab, self, self.player, win)

        # Redraw whenever the tab is switched to (handles deferred rendering)
        ...
        # Unlocked skills scrollable grid
        unlocked_box = tk.Frame(mgmt_tab, bg="#2a2a2a")
        unlocked_box.pack(pady=8, padx=15, fill="both", expand=True)
        tk.Label(unlocked_box, text="Unlocked Skills",
                 font=("Arial", 14, "bold"), bg="#2a2a2a", fg="#b0b0b0").pack(pady=5)

        sc = tk.Canvas(unlocked_box, bg="#2a2a2a", highlightthickness=0)
        sb = tk.Scrollbar(unlocked_box, orient="vertical", command=sc.yview)
        sf = tk.Frame(sc, bg="#2a2a2a")
        ...
        for i, sk in enumerate(self.player.unlocked_skills):
            ...
            tk.Label(row, text=sk['name'], anchor="center",
                     font=("Arial", 11, "bold"), bg="#3a3a3a", fg="#b0b0b0").pack(
                fill="x", pady=(0, 5))
