...
class Projectile:
    def __init__(self,x,y,angle,speed,life,radius,color,damage,owner='player', ptype='normal'):
...
class GameFrame(tk.Frame):
    ...
    def spawn_projectile(self, x, y, angle, speed, life, radius, color, damage, owner="player", ptype='normal'):
        self.projectiles.append(Projectile(x, y, angle, speed, life, radius, color, damage, owner, ptype))
